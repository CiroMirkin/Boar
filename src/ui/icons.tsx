...
export const LogInIcon = ({ className = '' }: IconProps) => <LogIn size={iconSize} className={className} />
export const LogOutIcon = ({ className = '' }: IconProps) => <LogOut size={iconSize} className={className} />
export const PencilIcon = ({ className = '' }: IconProps) => <Pencil size={iconSize} className={className} />
export const TrashIcon = ({ className = '' }: IconProps) => <Trash2 size={iconSize} className={className} />
export const BoldIcon = ({ className = '' }: IconProps) => <Bold size={iconSize} className={className} />
export const ItalicIcon = ({ className = '' }: IconProps) => <Italic size={iconSize} className={className} />
export const UnderlineIcon = ({ className = '' }: IconProps) => <Underline size={iconSize} className={className} />
export const ListIcon = ({ className = '' }: IconProps) => <List size={iconSize} className={className} />
export const ListOrderedIcon = ({ className = '' }: IconProps) => <ListOrdered size={iconSize} className={className} />
