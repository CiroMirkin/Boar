...
import { addTaskInFirstColumn, addTaskInTheLastColumn } from '@/pages/board/taskList/state/actions/addTask'
import { deleteThisTask } from '@/pages/board/taskList/state/actions/deleteTask'
import { cleanLastTaskList, deleteTheTaskListInThisIndex } from '@/pages/board/taskList/state/actions/deleteTaskList'
import { moveThisTaskToTheNextColumn, moveThisTaskToThePrevColumn } from '@/pages/board/taskList/state/actions/moveTask'
